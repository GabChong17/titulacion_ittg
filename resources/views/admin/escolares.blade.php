...
<head>
    ...
    <title>Servicios Escolares - Escritorio</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Citas</a>
                        <a class="collapse-item" href="cards.html">Oficio No inconveniencia</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Notificaciones Jurado</a>
                        <a class="collapse-item" href="utilities-border.html">Imprimir Protocolo</a>
                        <a class="collapse-item" href="utilities-animation.html">Imprimir Juramento</a>
                    </div>
                </div>
            </li>
