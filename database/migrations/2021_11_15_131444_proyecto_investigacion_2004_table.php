...
class ProyectoInvestigacion2004Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ProyectoInvestigacion2004', function (Blueprint $table) {
            $table->id();
            $table->string('Nombre');
    ...
    {
        Schema::dropIfExists('ProyectoInvestigacion2004');
    }
}
